...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.adapt_th_value = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents)
        self.adapt_th_value.setObjectName("adapt_th_value")
        self.gridLayout.addWidget(self.adapt_th_value, 11, 2, 1, 1)
